 ...
 * Copyright (c) shadcn.io: https://www.shadcn.io
 * Source:
...
export type ImageZoomV2Props = UncontrolledProps & {
	isZoomed?: ControlledProps['isZoomed']
	onZoomChange?: ControlledProps['onZoomChange']
	className?: string
	backdropClassName?: string
}
export const ImageZoomV2 = ({ className, backdropClassName, ...props }: ImageZoomV2Props) => (
	<div
		className={cn(
			'relative',
