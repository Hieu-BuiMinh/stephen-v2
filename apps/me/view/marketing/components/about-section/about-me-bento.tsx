...
export function AboutMeBento({ linkTo }: { linkTo?: string }) {
	...
	return (
		<BentoCard className="h-[275px] md:h-[304px] lg:h-[220px] overflow-hidden" linkTo={linkTo}>
			<div className="group flex h-full">
				...
				<div className="relative">
					<div className="group inline-block text-center">
						<div
							className="rounded-[20px] border border-border-primary p-2 transition-all duration-500 ease-out group-hover:border-foreground"
							style={{ width: 188, height: 278 }}
						>
							<div
								className="grid h-full place-items-center rounded-xl border-2 border-[#A5AEB81F]/10 bg-striped opacity-50"
