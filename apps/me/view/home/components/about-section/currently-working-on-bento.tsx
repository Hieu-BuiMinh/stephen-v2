...
import {
	...
	GlowingStarsTitle,
} from '@/view/home/components/about-section/glowing-background-stars-card'

function CurrentlyWorkingOnBento() {
	return (
		<div className="flex items-center relative justify-center antialiased size-full rounded-3xl bento-shadow">
			<GlowingStarsBackgroundCard className="border-none">
