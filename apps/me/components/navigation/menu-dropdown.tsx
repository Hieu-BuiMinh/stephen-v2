	...
	return (
		<DropdownMenu open={open} onOpenChange={setOpen} modal={false}>
			...
			<DropdownMenuContent
				onMouseEnter={handleOpen}
				onMouseLeave={handleClose}
				className="p-2 mt-1 rounded-xl bg-foreground/10 shadow-xl/30 outline-none backdrop-blur-sm border dark:border-background/50 border-background z-[80] before:absolute before:-inset-1 before:-top-4 overflow-visible before:-z-10"
				align="center"
			>
				{dropDownContent}
			</DropdownMenuContent>
