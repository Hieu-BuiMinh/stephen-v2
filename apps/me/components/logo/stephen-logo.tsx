...
export default function StephenLogo({ className }: { className?: string }) {
	return (
		<svg
			width="272"
			height="241"
		...
		>
			...
			<defs>
				...
				>
					...
					<feBlend mode="normal" in2="shape" result="effect1_innerShadow_85_178" />
				</filter>
			</defs>
		</svg>
	)
